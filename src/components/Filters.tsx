      ...
      <div className="col-span-3">
        <div className="bg-white p-6 rounded-lg shadow-sm">
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-2">
                {jobTypes.map((type) => (
                  <label key={type} className="flex items-center">
                    ...
                    />
                    <span className="ml-2 text-gray-700">{jobTypeDisplayNames[type] || type}</span>
                  </label>
                ))}
              </div>
            </div>
            ...
            <button onClick={resetFilters} className="w-full bg-blue-600 text-white py-2 rounded-md">
              Reset all filters
            </button>
          </div>
        </div>
